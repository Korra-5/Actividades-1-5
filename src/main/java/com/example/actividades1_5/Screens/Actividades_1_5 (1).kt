...
fun Actividad2() {
    ...
    Column(
        ...
        // Mostrar los indicadores de carga si showLoading es verdadero
        if (showLoading) {
            CircularProgressIndicator(
                color = Color.Red,
                strokeWidth = 10.dp
...
fun Actividad4() {
    ...
    val onValueChange: (String) -> Unit = { nuevoTexto ->
        val coma = nuevoTexto.replace(',', '.')
